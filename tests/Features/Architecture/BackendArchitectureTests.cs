...
public sealed class BackendArchitectureTests : BaseTests
{
    ...
    private static readonly IReadOnlySet<string> LegacyTestConventionExemptions =
        new HashSet<string>(StringComparer.Ordinal)
        {
            ...
            "Listenarr.Tests.Features.Api.Features.Verification.VerificationQueueStatusTests",
            "Listenarr.Tests.Features.Api.Services.PreIngestVerificationTests",
            "Listenarr.Tests.Features.Api.Services.SearchRelevanceFilterTests",
            "Listenarr.Tests.Features.Application.Audiobooks.AiLibrarySweepJudgeTests",
            ...
            "Listenarr.Tests.Features.Application.Audiobooks.LibraryMetadataGapsTests",
            "Listenarr.Tests.Features.Application.Audiobooks.MusicSmellDetectorTests",
            "Listenarr.Tests.Features.Application.Audiobooks.PromoteBlankFieldsTests",
            "Listenarr.Tests.Features.Application.Audiobooks.RecordingEditionClassifierTests",
            "Listenarr.Tests.Features.Application.Audiobooks.SeriesRunCompletionTests",
            "Listenarr.Tests.Features.Application.Audiobooks.SeriesWorkKeyTests",
            "Listenarr.Tests.Features.Application.Audiobooks.SplitAudioProbePlannerTests",
            "Listenarr.Tests.Features.Application.Audiobooks.SplitDestinationSuggesterTests",
            "Listenarr.Tests.Features.Application.Audiobooks.SplitSuggestionAiRefinerTests",
            "Listenarr.Tests.Features.Application.Audiobooks.SplitSuggestionGuardTests",
            "Listenarr.Tests.Features.Application.Audiobooks.TtsSmellDetectorTests",
            "Listenarr.Tests.Features.Application.Audiobooks.Verification.AudioCompletenessEstimatorTests",
            "Listenarr.Tests.Features.Application.Audiobooks.Verification.DeterministicIdentityVerifierTests",
            "Listenarr.Tests.Features.Application.Audiobooks.Verification.LibraryVerificationQueueServiceTests",
            "Listenarr.Tests.Features.Application.Audiobooks.Verification.LibraryVerificationRulesTests",
            "Listenarr.Tests.Features.Application.Audiobooks.Verification.SpokenCreditsExtractorTests",
            "Listenarr.Tests.Features.Application.Audiobooks.Verification.TranscriptMatcherTests",
            "Listenarr.Tests.Features.Application.Audiobooks.Verification.VerificationFileSelectionTests",
            "Listenarr.Tests.Features.Application.Audiobooks.VerificationEtaMathTests",
            "Listenarr.Tests.Features.Application.Audiobooks.WrongContentAutoRejectTests",
            "Listenarr.Tests.Features.Application.Downloads.ActivitySummaryTests",
            "Listenarr.Tests.Features.Application.Downloads.StalledDownloadReaperTests",
            "Listenarr.Tests.Features.Application.Images.ExternalCoverArtSweepServiceTests",
            "Listenarr.Tests.Features.Application.Notifications.SearchActivityTrackerTests",
            "Listenarr.Tests.Features.Application.Notifications.SearchProgressReporterAutomaticTests",
            "Listenarr.Tests.Features.Application.Search.AiReleaseGateJudgeTests",
            "Listenarr.Tests.Features.Application.Search.AudibleAuthorSearchWorkflowTests",
            "Listenarr.Tests.Features.Application.Search.AudiobookOnlyFilter_MusicSceneTests",
            "Listenarr.Tests.Features.Application.Search.BlockedReleaseMatcherTests",
            "Listenarr.Tests.Features.Application.Search.NumberConflictFilterTests",
            "Listenarr.Tests.Features.Application.Search.SearchResultScorer_RuntimeSizeTests",
            "Listenarr.Tests.Features.Application.Search.TitleMatcherTests",
            "Listenarr.Tests.Features.Domain.Downloads.QueueItemMatchScoreTests",
            "Listenarr.Tests.Features.Domain.Models.VerificationStatusTests",
            "Listenarr.Tests.Features.Infrastructure.DownloadClients.Qbittorrent.QbittorrentCompletionCandidateTests",
            "Listenarr.Tests.Features.Infrastructure.DownloadClients.Qbittorrent.QbittorrentSeedLimitAddTests",
            "Listenarr.Tests.Features.Infrastructure.Ffmpeg.AudioSampleExtractorWavTests",
            "Listenarr.Tests.Features.Infrastructure.Library.Organizing.OrganizeFilesystemTests",
            "Listenarr.Tests.Features.Infrastructure.Library.Scanning.ScanFileDiscoveryReproTests",
            "Listenarr.Tests.Features.Infrastructure.Metadata.AmazonProductPageParserTests",
            "Listenarr.Tests.Features.Infrastructure.Persistence.AsinUniqueIndexTests",
            "Listenarr.Tests.Features.Infrastructure.Repositories.AudiobookRepository_LastSearchTimeTests",
            "Listenarr.Tests.Features.Infrastructure.SeriesCatalogBackfillTests",
            "Listenarr.Tests.Features.Infrastructure.WhisperServiceTests",
            "Listenarr.Tests.Features.Api.Features.Images.ImageResponseBuilderCacheTests",
            "Listenarr.Tests.Features.Api.Features.Library.LibraryController_OrganizeTests",
            "Listenarr.Tests.Features.Api.Features.Library.LibraryUpdateWorkflow_AsinConflictTests",
    ...
    public void LegacyHostPathIdentity_StaysOnExplicitAllowList()
    {
        var allowed = new HashSet<string>(StringComparer.OrdinalIgnoreCase)
        {
            ...
            // Fork-local features predating the path-identity migration; move to
            // identity-aware comparisons when these workflows are next reworked.
            "listenarr.api/Features/Library/LibraryOrganizeSweepWorkflow.Helpers.cs",
            "listenarr.api/Features/Library/LibraryFileStreamWorkflow.cs",
            "listenarr.application/Audiobooks/Files/FileExtractionService.cs",
            "listenarr.infrastructure/Library/Scanning/ScanJobProcessor.ScanRoot.cs",
