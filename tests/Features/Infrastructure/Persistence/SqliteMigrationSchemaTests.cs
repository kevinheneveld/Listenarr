...
public class SqliteMigrationSchemaTests : BaseTests
{
    ...
    // This fork created ProcessExecutionLogs in its own earlier migration; upstream's
    // re-stamped duplicate (20260809121006) was dropped in the v1.3.0 sync merge.
    private const string PreConsolidationFrontierId =
        "20260809100000_AddAudiobookshelfSettingsToApplicationSettings";
    ...
    public async Task MigrationHistory_ContainsOnlyRetainedRepairsAndConsolidatedPrMigrationAfterCanary()
    {
        ...
        Assert.Equal(
            [
                // Fork-local migrations (kevin/canary-live) in timestamp order…
                "20260701163938_AddAutomaticSearchTuning",
                "20260701180228_AddAuthorMonitoringExclusions",
                "20260702180000_AddReplaceStubTargetToMoveJobs",
                "20260702200000_AddProcessExecutionLogs",
                "20260702210000_AddAudiobookVerification",
                "20260703170000_AddBlockedReleasesAndVerificationJobs",
                "20260703210000_AddVerificationEscalationModel",
                "20260704160000_AddVerificationAutoRejectWrongContent",
                "20260706170000_AddMonitoredSeriesAsinPinned",
                "20260710170000_AddAiAssistSettings",
                "20260710200000_AddAiAssistGateSearches",
    ...
    public async Task ConsolidatedMigration_DowngradesOneStepAndReappliesCleanly()
    {
        ...
        await migrator.MigrateAsync(PreConsolidationFrontierId);
