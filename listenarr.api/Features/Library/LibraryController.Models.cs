...
public partial class LibraryController
{
    ...
    public class MoveRequest
    {
        ...
        /// <summary>
        /// Allow the move to delete a target directory that holds only stale
        /// non-audio leftovers (metadata stub) before moving content into it.
        /// The executor re-verifies the stub claim before deleting anything.
        /// </summary>
