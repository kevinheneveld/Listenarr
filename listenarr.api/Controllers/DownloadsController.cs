...
public class DownloadsController : ControllerBase
{
    ...
    /// <summary>
    /// Activity summary + collapsed list for the Activity page.
    /// Returns category counts (in-progress, blocked, and 24h imported/failed/stalled) plus a
    /// per-book collapsed, newest-first list. With no <paramref name="category"/> the list is the
    /// default in-progress + blocked view; pass a category to drill into that bucket.
    /// </summary>
