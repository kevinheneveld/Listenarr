...
import type { Audiobook, AudibleBookMetadata, QualityProfile, SeriesCatalogBook } from '@/types'
...
async function loadCatalog() {
  ...
  try {
    ...
    catalogError.value = err instanceof Error ? err.message : 'Failed to load the series catalog.'
  } finally {
              ...
              <div class="catalog-header">
                <label class="select-all">
                  ...
                  <span>
                    Select all
                    <span class="muted"
                      >({{ addableBooks.length }} addable, {{ ownedCount }} already in
                      library)</span
                    >
                  </span>
                </label>
                ...
                <li v-for="book in catalog" :key="book.asin || book.title" class="catalog-item">
                  ...
                  <div class="catalog-meta">
                    <div class="catalog-title">
                      <span class="catalog-pos" v-if="book.seriesNumber"
