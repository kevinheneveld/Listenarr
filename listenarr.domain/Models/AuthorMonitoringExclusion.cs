...
namespace Listenarr.Domain.Models
{
    ...
    /// monitored author's catalog sync: without it, deleting a book by a
    /// monitored author only triggered the next sweep to re-discover it as
    /// "missing" and add it straight back (then auto-search re-grabbed it).
    ///
