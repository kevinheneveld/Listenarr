...
namespace Listenarr.Application.Audiobooks.Contracts
{
    ...
    public interface IMoveQueueService
    {
        ...
        Task<MoveQueueHealthSnapshot> GetQueueHealthAsync(CancellationToken cancellationToken = default);        Task<MoveJob?> GetJobAsync(Guid id, CancellationToken cancellationToken = default);
