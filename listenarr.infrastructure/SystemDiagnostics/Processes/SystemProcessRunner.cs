...
namespace Listenarr.Infrastructure.SystemDiagnostics.Processes
{
    public class SystemProcessRunner : IProcessRunner
    {
        ...
        public Task<ProcessResult> RunAsync(ProcessStartInfo startInfo, int timeoutMs = 60000, CancellationToken cancellationToken = default)
            => RunAsync(startInfo, timeoutMs, cancellationToken, priorityClass: null);

        public async Task<ProcessResult> RunAsync(ProcessStartInfo startInfo, int timeoutMs, CancellationToken cancellationToken, ProcessPriorityClass? priorityClass)
        {
