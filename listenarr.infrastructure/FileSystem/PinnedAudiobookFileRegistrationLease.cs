    ...
    IAudiobookFileRegistrationLease
{
        ...
        Func<int, bool>? commitRegistration = null)
    {
        ...
        try
        {
            ...
            // Windows has no /proc-style stable handle path; neither does macOS.
            // Both extract via the canonical path while the pin holds the file
            // open — the same (accepted) rename-race profile in each case.
