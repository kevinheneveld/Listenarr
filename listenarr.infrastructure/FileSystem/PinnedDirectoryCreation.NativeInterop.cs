...
internal sealed partial class PinnedDirectoryCreation
{
    ...
    // Variadic fcntl: safe ONLY for commands that ignore the third argument
    // (e.g. F_FULLFSYNC). Never use for F_GETPATH-style commands that READ the
    // vararg — Apple arm64 passes varargs on the stack while this fixed
    // signature passes a register, which fatally corrupts the process.
